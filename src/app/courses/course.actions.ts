...
export enum CourseActionTypes {
    ...
    AllCoursesRequested ='[Courses Home Pages]All Courses Requested',
...
export type CourseActions = CourseRequested |  CourseLoaded | AllCoursesLoaded | AllCoursesRequested | CourseSaved;